<template>
  <view class="oa-content" :style="{ paddingBottom: vuex_is_black_stripe ? '20px' : 0 }">
    <!-- 	<view class="a-0" :style="{height: vuex_custom_bar_height + 'px'}">
			<image src="https://www.tmsglm.com/statics/top_bg.jpg" style="width: 100%;height: 100%;"></image>
          ...
          <view class="n-10">
            ...
            <view click="n-12">
              <block v-if="item.imgUrl">
                <image class="n-13" v-for="(item, index) in v.images.slice(0, 3)" :key="index" :src="item.imgUrl" @click="previewImages(item.imgUrl, v.images.slice(0, 3))"></image>
              </block>
            </view>
          </view>
          <view class="n-10">
            ...
            <view click="n-12">
              <block v-if="item.imgUrl">
                <image class="n-13" v-for="(item, index) in v.images.slice(3, 6)" :key="index" :src="item.imgUrl" @click="previewImages(item.imgUrl, v.images.slice(3, 6))"></image>
              </block>
            </view>
          </view>
          <view class="n-10">
            ...
            <view click="n-12">
              <block v-if="item.imgUrl">
                <image class="n-13" v-for="(item, index) in v.images.slice(6, 10)" :key="index" :src="item.imgUrl" @click="previewImages(item.imgUrl, v.images.slice(6, 10))"></image>
              </block>
            </view>
          </view>
        </view>
